...
#Code Book for Getting and Cleaning Data_Course Project

##Introduction
This CodeBook describes the transformations performed on the data and the detailed descriptions of the variables used in the data set.

##Data Details (from readme.txt file of the dataset)
